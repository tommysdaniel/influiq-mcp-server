...
export function registerAuthTools(server, client) {
    ...
    // ── Login ──
    server.registerTool("influiq_login", {
...
No arguments required.`,
    ...
    // ── Auth Status ──
    server.registerTool("influiq_auth_status", {
...
No arguments required.`,
        ...
        if (mode === "none") {
            return {
                content: [
                    {
                        type: "text",
                        text: "Not authenticated. You have two options:\n\n" +
        ...
        const modeLabel = mode === "api-key" ? "API Key" : "Browser login session";
        return {
            content: [
                {
                    type: "text",
