...
Returns: List of influencer profiles with metrics.`,
      inputSchema: {
        ...
        categories: z
          ...
          .optional()
          .describe(
            'Category slugs: tech, gaming, beauty, fashion, food, travel, fitness, education, entertainment, business, lifestyle, sports, science, art, automotive',
          ),
        follower_min: z
          .number()
          .int()
    ...
    async (params) => {
      try {
        ...
        if (params.follower_min != null) query.followerMin = params.follower_min;
        if (params.follower_max != null) query.followerMax = params.follower_max;
        if (params.engagement_tier) query.engagementTier = params.engagement_tier;
        if (params.language) query.language = params.language;
        if (params.country) query.country = params.country;
        if (params.is_verified != null) query.isVerified = params.is_verified;
